package com.jtrent238.liferaft.entity;

import java.util.List;

import com.jtrent238.liferaft.ItemLoader;
...
public class EntityRaft extends Entity
{
    ...
    public EntityRaft (World p_i1704_1_)
    {
        super(p_i1704_1_);
    ...
    public EntityRaft(World p_i1705_1_, double p_i1705_2_, double p_i1705_4_, double p_i1705_6_)
    {
        this(p_i1705_1_);
